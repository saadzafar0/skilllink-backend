    ...
    try {
        ...
        for (const skillName of skills) {
            ...
            if (skillResult.recordset.length > 0) {
                ...
                const insertSkill = await transaction.request()
                    .input("skillName", sql.NVarChar, skillName)
                    .query("INSERT INTO Skills (skillName) OUTPUT INSERTED.skillID VALUES (@skillName)");
            ...
            await transaction.request()
                ...
                .query("INSERT INTO FreelancerSkills (fID, skillID) VALUES (@fID, @skillID)");
        }
...
router.delete("/:freelancerID/:skillName", async (req, res) => {
    ...
    try {
        ...
        await pool.request()
            .input("fID", sql.Int, freelancerID)
            .input("skillID", sql.Int, skillID)
            .query("DELETE FROM FreelancerSkills WHERE fID = @fID AND skillID = @skillID");
